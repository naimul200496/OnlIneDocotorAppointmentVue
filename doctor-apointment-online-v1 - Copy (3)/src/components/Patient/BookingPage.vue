...
export default {
    ...
    props: ['docid'],
        setup(){
            const docStore = useStoreAddDoctor();
             return { docStore };
        },
    ...
    async mounted() {
       ...
       alert('Hello',this.docid)
       let ddd = this.$route.params.docid;
        this.doctor = await this.docStore.getDoctorDetail(ddd);
        console.log('PasDocId:',this.docid)
        console.log('IndividualDoc',this.doctor)
